  ...
  return (
    <div className="contact">
      ...
      <div className="description">
        ...
        <p>
          I'm seeking out opportunites to collaborate with companies / agenices
          / individuals to work with them. I want to bring my collective design
          to the table to solve the real business-problems.
        </p>
      ...
      <div className="contact__social__links">
        ...
        <a href="https://github.com/RishikeshPolasa">Github</a>
        {/* </div> */}
        {/* <div className="contact__social__link"> */}
        <a href="https://www.linkedin.com/in/rishikeshpolasa/">linkedin</a>
        {/* </div> */}
      </div>
    </div>
  );
